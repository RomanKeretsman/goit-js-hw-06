...
console.log('Задание 5:', getUserWithEmail(users, 'shereeanthony@kog.com')); // {объект пользователя Sheree Anthony}
console.log('Задание 5:', getUserWithEmail(users, 'elmahead@omatom.com')); // {объект пользователя Elma Head}
...
console.log('Задание 8:', getUsersWithFriend(users, 'Briana Decker')); // [ 'Sharlene Bush', 'Sheree Anthony' ]
console.log('Задание 8:', getUsersWithFriend(users, 'Goldie Gentry')); // [ 'Elma Head', 'Sheree Anthony' ]
...
const getSortedUniqueSkills = users => users
  .reduce((allSkills, skillName) => {
    const uniqueSkills = skillName.skills.filter(skill => !allSkills.includes(skill))
